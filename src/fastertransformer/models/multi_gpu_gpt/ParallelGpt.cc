                             ...
                             Job*                        job)
{
    ...
    forward(&output_tensors_map, &input_tensors_map, gpt_weights, job);
}
...
//    std::ofstream outfile("outputTime.txt",std::ios::app);
